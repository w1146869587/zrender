    ...
    function (require) {
        ...
        var domHandlers = {
            ...
            touchstart: function (event, manually) {
                ...
                // 分发config.EVENT.MOUSEDOWN事件
                this._mouseDownTarget = this._lastHover;
                this._dispatchAgency(this._lastHover, EVENT.TOUCHSTART, event);
                this._lastDownButton = event.button;
            },
            ...
            touchmove: function (event, manually) {
                ...
                // 分发config.EVENT.MOUSEMOVE事件
                this._dispatchAgency(this._lastHover, EVENT.TOUCHMOVE, event);
            ...
            touchend: function (event, manually) {
                ...
                // 分发config.EVENT.MOUSEUP事件
                this._dispatchAgency(this._lastHover, EVENT.TOUCHEND, event);
                this._processDrop(event);
                this._processDragEnd(event);
            }
        };
